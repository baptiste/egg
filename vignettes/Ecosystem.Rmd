...
Parts of this document were [originally written by Hadley Wickham as a draft vignette](https://github.com/tidyverse/ggplot2/issues/1239) for the 'ggplot2' package; it has since been shuffled around quite a bit and I have lost track of the exact history of edits.

...
---
 ...
 [![R build status](https://github.com/baptiste/egg/workflows/R-CMD-check/badge.svg)](https://github.com/baptiste/egg/actions)
...
This is a convenience function similar to `grid.arrange`, specialised for ggplot2 objects, which attempts to align the plot panels,

```{r ggarrange, fig.height=4}

...
vignette: >
  ...
  %\VignetteIndexEntry{egg: (fragile) extensions for ggplot2}
output:
  knitr:::html_vignette:
    toc: yes
---
...
The following function is used to illustrate the  structure of ggplot2 plots.
...
Widths and heights can be provided for the layout.
